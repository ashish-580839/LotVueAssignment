angular.module('lotvueAssignment').config(['$stateProvider','$urlRouterProvider', 'cfpLoadingBarProvider', '$httpProvider',function($stateProvider,$urlRouterProvider,cfpLoadingBarProvider,$httpProvider) {
  ...
  var forbiddenState = {
    name: 'container.public.forbidden',
    url: '/not_allowed',
